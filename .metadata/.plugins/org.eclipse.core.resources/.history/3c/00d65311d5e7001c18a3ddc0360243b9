...
public class AssetManager {
	...
	public void setNPC() {
		...
		gamePanel.npc[1] = new Student(gamePanel, "KFet Man", true, "right_stop");
		gamePanel.npc[1].setX(11 * gamePanel.getTileSize() + gamePanel.getTileSize() / 2);
		gamePanel.npc[1].setY(9 * gamePanel.getTileSize());
	}
