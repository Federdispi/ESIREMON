...
public class AssetManager {
	...
	public void setNPC() {
		...
		gamePanel.npc[4] = new Student(gamePanel, "Insigam", true, "down_stop", 5);
	...
	public void setObject() {		
		...
		gamePanel.object[4] = new Entrance(gamePanel, "Steinbrunn");
